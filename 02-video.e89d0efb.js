...
"[object Array]"!=r.call(e)?t.reject(TypeError("Not an array")):new t(function(n,r){if("function"!=typeof n||"function"!=typeof r)throw TypeError("Not a function");s(t,e,function(e,t){n(t)},r)}))}),h)}(),e.exports&&(e.exports=L[t]),n.exports),A=new WeakMap;/**
 ...
 * @return {void}
 */function I(e,t,n){var r=A.get(e.element)||{};t in r||(r[t]=[]),r[t].push(n),A.set(e.element,r)}/**
 * Get the callbacks for a player and event or method.
 *
 * @param {Player} player The player object.
 * @param {string} name The method or event name
 * @return {function[]}
 */function q(e,t){return(A.get(e.element)||{})[t]||[]}/**
 ...
 */function V(e,t,n){var r=A.get(e.element)||{};if(!r[t])return!0;// If no callback is passed, remove all callbacks for the event
...
r.element=i,r._originalElement=e,n=e,o=A.get(n),A.set(i,o),A.delete(n),Q.set(r.element,r),t)}).catch(n)}});if(// Store a copy of this Player in the map
...
return t.ready().then(function(){I(t,e,{resolve:r,reject:o}),W(t,e,n)}).catch(o)})}},{key:"get",value:function(e){var t=this;return new R(function(n,r){// We are storing the resolve/reject handlers to call later, so we
// can’t return here.
// eslint-disable-next-line promise/always-return
return e=O(e,"get"),t.ready().then(function(){I(t,e,{resolve:n,reject:r}),W(t,e)}).catch(r)})}},{key:"set",value:function(e,t){var n=this;return new R(function(r,o){if(e=O(e,"set"),null==t)throw TypeError("There must be a value to set.");// We are storing the resolve/reject handlers to call later, so we
// can’t return here.
// eslint-disable-next-line promise/always-return
